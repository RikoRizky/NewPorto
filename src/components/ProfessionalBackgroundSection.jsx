...
export const rawExperiences = [
    ...
    {
        id: 7,
        title: 'Sertifikat Tambahan 1',
        role: 'Peserta / Keahlian',
        issuer: 'Penerbit Sertifikat',
        category: 'Sertifikat',
        icon: 'fa-certificate',
        tags: ['Pencapaian'],
        description:
            'Deskripsi atau penjelasan mengenai pencapaian dan keahlian untuk sertifikat ini.',
        year: '2023',
        certificate: 'https://drive.google.com/file/d/1I5pkz1SOur4efirMGvld2OLaWMSf_e1n/view?usp=sharing',
    },
    {
        id: 8,
        title: 'Sertifikat Tambahan 2',
        role: 'Peserta / Keahlian',
        issuer: 'Penerbit Sertifikat',
        category: 'Sertifikat',
        icon: 'fa-certificate',
...
export default function RelatedExperience() {
    ...
    useEffect(() => {
        ...
        if (rightListRef.current && itemRefs.current[activeIndex]) {
            const targetChild = itemRefs.current[activeIndex];
            ...
            const scrollTopOffset = childRect.top - listRect.top + rightList.scrollTop - (rightList.clientHeight / 2) + (childRect.height / 2);
            
            rightList.scrollTo({
                top: Math.max(0, scrollTopOffset),
                behavior: 'smooth',
            });
        }
        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-1 sm:pt-4 pb-6 sm:pb-12 w-full flex flex-col justify-start md:justify-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 lg:gap-10 items-center justify-center">
                    ...
                    <div className="hidden md:block md:col-span-7 pl-2 lg:pl-4 relative h-full flex flex-col">
                        ...
                        {/* Timeline List Items */}
                        <div ref={rightListRef} className="space-y-2.5 relative pl-7 lg:pl-8 flex-1 max-h-[calc(100vh-12rem)] overflow-y-auto no-scrollbar pb-10">
